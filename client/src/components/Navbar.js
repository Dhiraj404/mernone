        ...
        if (state) {
            ...
            return (
                <>
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link mx-3" to="/logout">Log Out</NavLink>
                    </li>
            ...
            return (
                <>
                    ...
                    <li className="nav-item">
                        <NavLink className="nav-link mx-3" to="/signup">Registration</NavLink>
                    </li>
        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-dark bg-dark fw-bold">
                <NavLink className="navbar-brand ml-3" to="#">
                    <img src={logo} alt=" Sorry cannot view Dhiraj" />
                </NavLink>
